...
import (
	...
	"github.com/leros321/quay-exporter/pkg/quay/billing"
	"github.com/leros321/quay-exporter/pkg/quay/build"
	"github.com/leros321/quay-exporter/pkg/quay/discovery"
	"github.com/leros321/quay-exporter/pkg/quay/error"
	"github.com/leros321/quay-exporter/pkg/quay/globalmessages"
	"github.com/leros321/quay-exporter/pkg/quay/image"
	"github.com/leros321/quay-exporter/pkg/quay/logs"
	"github.com/leros321/quay-exporter/pkg/quay/manifest"
	"github.com/leros321/quay-exporter/pkg/quay/organization"
	"github.com/leros321/quay-exporter/pkg/quay/permission"
	"github.com/leros321/quay-exporter/pkg/quay/prototype"
	"github.com/leros321/quay-exporter/pkg/quay/repository"
	"github.com/leros321/quay-exporter/pkg/quay/repositorynotification"
	"github.com/leros321/quay-exporter/pkg/quay/repotoken"
	"github.com/leros321/quay-exporter/pkg/quay/robot"
	"github.com/leros321/quay-exporter/pkg/quay/search"
	"github.com/leros321/quay-exporter/pkg/quay/secscan"
	"github.com/leros321/quay-exporter/pkg/quay/signing"
	"github.com/leros321/quay-exporter/pkg/quay/tag"
	"github.com/leros321/quay-exporter/pkg/quay/team"
	"github.com/leros321/quay-exporter/pkg/quay/trigger"
	"github.com/leros321/quay-exporter/pkg/quay/user"
)
...
const (
	...
	DefaultHost string = "mtr.external.otc.telekomcloud.com"
